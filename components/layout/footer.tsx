...
export function Footer() {
  ...
  const socialLinks = [
    {
      href: 'https://www.linkedin.com/in/hardat-panchal-b93341377',
      label: 'LinkedIn',
      icon: (
    ...
    {
      href: 'https://www.facebook.com/share/18HUcRTsLN/',
      label: 'Facebook',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      href: 'https://www.instagram.com/horizonixx_international',
      label: 'Instagram',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
